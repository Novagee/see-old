...
/*┌──────────────────────────────────────────────────────────────────────────────────────────────────┐
  ...
  └──────────────────────────────────────────────────────────────────────────────────────────────────┘*/
    dispersionSortDescriptor = [[[NSSortDescriptor alloc] initWithKey:@"dispersion" ascending:YES] copy];
    sortDescriptors = [@[dispersionSortDescriptor] copy];
    timeAssociations = [[NSMutableArray arrayWithCapacity:48] mutableCopy];
/*┌──────────────────────────────────────────────────────────────────────────────────────────────────┐
