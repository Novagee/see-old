...
/**@defgroup TBI_time_group Datetime functions.
*/
...
* The TBI_gettimeofday() function shall obtain the current time, expressed as seconds and microseconds since EPOCH (00:00:00 UTC on 1 January 1970). 
...
* @retval The TBI_gettimeofday() function shall return 0 and no value shall be reserved to indicate an error.
*/
int TBI_gettimeofday(struct timeval *tv, struct timezone *tz)
{
...
*/
uint64_t TBI_time_get_ms(struct timeval* tv)
{
	if(!tv){
