//
//  SeequContactTopicsViewController.m
//  ProTime
//
...
@interface SeequContactTopicsViewController ()

@end

@implementation SeequContactTopicsViewController
...
- (void) viewWillAppear:(BOOL)animated {
	...
	((NavigationBar*) self.navigationController.navigationBar).titleImage = [UIImage imageNamed:@"seequNavigationTitleTopics.png"];
...
- (void) UpdateUI {
    ...
    [self onButtonFilter:self.buttonWork];
...
- (IBAction)onButtonFilter:(id)sender {
    ...
    switch (button.tag) {
        case 1: {
            topicsType = Topics_Type_Work;
            [self.buttonWork setBackgroundImage:[UIImage imageNamed:@"segTopicsWorkSel.png"] forState:UIControlStateNormal];
            [self.buttonPlay setBackgroundImage:[UIImage imageNamed:@"segTopicsPlay.png"] forState:UIControlStateNormal];
        }
            break;
        case 2: {
            topicsType = Topics_Type_Play;
            [self.buttonWork setBackgroundImage:[UIImage imageNamed:@"segTopicsWork.png"] forState:UIControlStateNormal];
            [self.buttonPlay setBackgroundImage:[UIImage imageNamed:@"segTopicsPlaySel.png"] forState:UIControlStateNormal];
        }
            break;
    ...
    [self filterContactsWithSegment_Type:topicsType];
}

- (IBAction)onButtonTopicDetail:(id)sender {
    SeequContactTopicsDetailViewController *topicsDetailViewController = [[SeequContactTopicsDetailViewController alloc] initWithNibName:@"SeequContactTopicsDetailViewController" bundle:nil];
    topicsDetailViewController.contactObj = self.contactObj;
    topicsDetailViewController.videoViewState = self.videoViewState;
    [self.navigationController pushViewController:topicsDetailViewController animated:YES];
}
