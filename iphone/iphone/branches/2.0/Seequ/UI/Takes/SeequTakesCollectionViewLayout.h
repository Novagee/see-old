...
@class SeequTakesCollectionViewLayout;
...
@protocol SeequCollectionViewDelegateWaterfallLayout <UICollectionViewDelegate>
 ...
 */
@interface SeequTakesCollectionViewLayout : UICollectionViewLayout
