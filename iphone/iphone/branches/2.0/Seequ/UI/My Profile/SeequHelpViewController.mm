...
@interface SeequHelpViewController ()

@end

@implementation SeequHelpViewController
...
- (void)viewDidLoad
{
    ...
    self.scrollView.contentSize = CGSizeMake(320, 745);
...
- (void) viewWillAppear:(BOOL)animated {
	...
	((NavigationBar*) self.navigationController.navigationBar).titleImage = [UIImage imageNamed:@"seequNavigationTitleHelp.png"];
