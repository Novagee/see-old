//
//  SeequStateListViewController.m
//  ProTime
//
...
@interface SeequStateListViewController ()

@end

@implementation SeequStateListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //    currentSelected
    SeequState* state  = [self.arrayOfList objectAtIndex:indexPath.row];
    
    if (self.currentSelected && [state.stateID integerValue] == [self.currentSelected.stateID integerValue]) {
        cell.accessoryType = UITableViewCellAccessoryCheckmark;
    } else {
        cell.accessoryType = UITableViewCellAccessoryNone;
    }
    
    cell.textLabel.text = [NSString stringWithFormat:@"(%@)  %@ ", state.stateAbbrev, state.stateName];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if ([_delegate respondsToSelector:@selector(didSelectState:State:)]) {
        [_delegate didSelectState:self State:[self.arrayOfList objectAtIndex:indexPath.row]];
    }
