...
- (void)observeValueForKeyPath:(NSString*) path 
	...
	if (context == AVPlayerDemoPlaybackViewControllerStatusObservationContext) {
        ...
        AVPlayerItem *newPlayerItem = [change objectForKey:NSKeyValueChangeNewKey];
         [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(itemDidFinishPlaying:) name:AVPlayerItemDidPlayToEndTimeNotification object:newPlayerItem];
        if (newPlayerItem) {
...
-(void)itemDidFinishPlaying:(NSNotification *) notification {
    ...
    NSLog(@"±±±±±±±±");
    if ([self.videoDelegate respondsToSelector:@selector(didFinishPlaying)]) {
        [self.videoDelegate didFinishPlaying];
    }
}
