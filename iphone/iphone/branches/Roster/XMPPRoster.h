...
@interface XMPPRoster : NSObject
{
   ...
   */
	...
	id <XMPPRosterStorage> __weak xmppRosterStorage;
...
@property (weak, nonatomic, readonly) id <XMPPRosterStorage> xmppRosterStorage;
...
@property (nonatomic, strong) XMPPRoster *parent;
