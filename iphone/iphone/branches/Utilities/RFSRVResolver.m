...
{
	return [[RFSRVRecord alloc] initWithPriority:p1 weight:w port:p2 target:t] ;
}
...
{
	RFSRVResolver *srvResolver = [[RFSRVResolver alloc] initWithStream:aXmppStream] ;
...
// is done in the -_processRecord:length: method.
{
    ...
    obj = (__bridge RFSRVResolver *) context;
...
#pragma unused(data)
    ...
    obj = (__bridge RFSRVResolver *) info;
    //NSCAssert([obj isKindOfClass:[RFSRVResolver class]], @"obj is not of class RFSRVResolver");
