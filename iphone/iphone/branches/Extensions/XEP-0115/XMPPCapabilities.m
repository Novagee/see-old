...
NSInteger sortIdentities(NSXMLElement *identity1, NSXMLElement *identity2, void *context)
{
	...
	// 
	// All sort operations MUST be performed using "i;octet" idoubs2AppDelegate as specified in Section 9.3 of RFC 4790.
...
- (void)handleDiscoResponse:(NSXMLElement *)query fromJID:(XMPPJID *)jid
{
	...
	if (hashResponse)
	{
		...
		else
		{
			...
			requestIndex--;
			[jids replaceObjectAtIndex:0 withObject:@(requestIndex)];
